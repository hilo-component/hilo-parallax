...
var CacheMixin = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_hilojs_view_Graphics__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_hilojs_view_Graphics___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_hilojs_view_Graphics__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hilojs_view_Container__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hilojs_view_Container___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_hilojs_view_Container__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3____ = __webpack_require__(5);
...
var Demo = function (_initStage) {
  ...
  function Demo(props) {
    ...
    _this.mouseMove = function (e) {
      var x = e.clientX;
      _this.bgWrapper.cameraAnimateTo(-x / 2 * _this.dpr);
    };

    _this.orientationHandler = function (e) {
      if (Math.abs(_this.gamma - e.gamma) >= 5) {
        console.log(Math.round(e.gamma));
        _this.bgWrapper.cameraAnimateTo(e.gamma * -3 * _this.dpr);
        _this.gamma = e.gamma;
      }
    };
  ...
  _createClass(Demo, [{
    key: 'init',
    value: function init() {
      var bg0 = this.drawBg('#ff0000');
      bg0.x = 50 * this.dpr;
      bg0.y = 100 * this.dpr;
      var bg1 = this.drawBg('#ffff00');
      bg1.x = 150 * this.dpr;
      bg1.y = 150 * this.dpr;

      this.bgWrapper = new __WEBPACK_IMPORTED_MODULE_3____["a" /* default */]({
        childrens: [{
          depth: 0.5,
          children: bg0
        }, {
    ...
    value: function drawBg(color) {
      var bg = new __WEBPACK_IMPORTED_MODULE_2_hilojs_view_Container___default.a();
      var grap = new __WEBPACK_IMPORTED_MODULE_1_hilojs_view_Graphics___default.a();
