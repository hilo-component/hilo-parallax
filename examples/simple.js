...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hilojs_view_Graphics__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hilojs_view_Graphics___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_hilojs_view_Graphics__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_hilo_init_stage__ = __webpack_require__(6);
...
var Demo = function (_initStage) {
  ...
  _createClass(Demo, [{
    ...
    value: function init() {
      ...
      this.bgWrapper = new __WEBPACK_IMPORTED_MODULE_4____["a" /* default */]({
        childrens: [{
          depth: 0.5,
          children: bg0
        }, {
        ...
        type: 'x',
        duration: 10000,
        ease: __WEBPACK_IMPORTED_MODULE_2_hilojs_tween_Ease___default.a.Linear.EaseNone,
        width: this.width,
        height: this.height,
        loop: true,
        startPercent: 0.3,
    ...
    value: function drawBg(color) {
      var bg = new __WEBPACK_IMPORTED_MODULE_1_hilojs_view_Container___default.a();
      var grap = new __WEBPACK_IMPORTED_MODULE_0_hilojs_view_Graphics___default.a();
  ...
  return Demo;
}(__WEBPACK_IMPORTED_MODULE_3_hilo_init_stage__["a" /* default */]);
